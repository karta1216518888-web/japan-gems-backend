...
async function main() {
  ...
  const unsplashImages: Record<string, string> = {
    '箕面大滝': 'https://images.unsplash.com/photo-1578643463396-0997cb532858?w=800',
    '伊根の舟屋': 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?w=800',
    '天王寺': 'https://images.unsplash.com/photo-1590059899731-a382839e5549?w=800',
    '新世界': 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=800',
    '臨空城': 'https://images.unsplash.com/photo-1524413840807-0c3cb6fa808d?w=800',
    ...
    '銀閣寺': 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=800',
    ...
    '八坂神社': 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800',
    '伏見稻荷大社': 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?w=800',
